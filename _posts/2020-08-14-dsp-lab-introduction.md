...
equipment: "A computer with GNU Radio and audio output. The GQRX radio section additionally requires a receiver, antenna, and drivers."
preparation: "Try the signal-generator exercises first. Classes without a receiver can skip GQRX and continue with simulated signals."
---
...
![gqrx]({{ site.baseurl }}/images/dsp-intro/gqrx-window.png)
...
![io]({{ site.baseurl }}/images/dsp-intro/gqrx-device-settings.png)

Once it is all in order click play. The window should show the spectrum as such:

![spect out]({{ site.baseurl }}/images/dsp-intro/gqrx-spectrum.png)
...
![io]({{ site.baseurl }}/images/dsp-intro/gqrx-audio-settings.png)
...
![io]({{ site.baseurl }}/images/dsp-intro/gqrx-receiver-settings.png)
...
![start gnuradio-companion]({{ site.baseurl }}/images/dsp-intro/launch-gnu-radio.png)

This opens GNU Radio Companion (GRC):

![GNU Radio gui]({{ site.baseurl }}/images/dsp-intro/gnu-radio-workspace.png)
...
![top_block]({{ site.baseurl }}/images/dsp-intro/top-block-settings.png) ![variable block]({{ site.baseurl }}/images/dsp-intro/variable-block.png)
...
![adding signal source]({{ site.baseurl }}/images/dsp-intro/add-signal-source.png)
...
![datatypes]({{ site.baseurl }}/images/dsp-intro/data-types.png)
...
![throttle blocking]({{ site.baseurl }}/images/dsp-intro/throttle-block.png)
...
![Example 1 Flowgraph]({{ site.baseurl }}/images/dsp-intro/example-1-flowgraph.png)
...
![Example 1 Output Frequency]({{ site.baseurl }}/images/dsp-intro/example-1-frequency-display.png) ![Example 1 Output Frequency]({{ site.baseurl }}/images/dsp-intro/example-1-time-display.png)
...
![signal source default freq]({{ site.baseurl }}/images/dsp-intro/signal-frequency.png)

![QT Range properties]({{ site.baseurl }}/images/dsp-intro/range-settings.png)
...
![Audio sink]({{ site.baseurl }}/images/dsp-intro/audio-sink.png)
...
![GUI out ex01_2]({{ site.baseurl }}/images/dsp-intro/example-2-display.png)
...
![GUI start ex01_3]({{ site.baseurl }}/images/dsp-intro/example-3-flowgraph.png)
...
![GUI start ex01_3]({{ site.baseurl }}/images/dsp-intro/example-3-display.png)

Double-click the second “QT GUI Range” to adjust waveform offset. Change its “Properties” as shown below:

![Offset]({{ site.baseurl }}/images/dsp-intro/signal-offset.png)
...
![Waveform chooser]({{ site.baseurl }}/images/dsp-intro/waveform-chooser.png)

Finally, double-click on the “Signal Source” block and modify the “Properties” to look as follows.

![Waveform properties]({{ site.baseurl }}/images/dsp-intro/waveform-settings.png)
...
![Output 1]({{ site.baseurl }}/images/dsp-intro/waveform-display.png)
...
![GUI Hints]({{ site.baseurl }}/images/dsp-intro/gui-layout-hint-1.png)
![GUI Hints]({{ site.baseurl }}/images/dsp-intro/gui-layout-hint-2.png)
![GUI Hints]({{ site.baseurl }}/images/dsp-intro/gui-layout-hint-3.png)
![GUI Hints]({{ site.baseurl }}/images/dsp-intro/gui-layout-hint-4.png)
![GUI Hints]({{ site.baseurl }}/images/dsp-intro/gui-layout-hint-5.png)

This give the following Output:

![Output 1_rearranged]({{ site.baseurl }}/images/dsp-intro/rearranged-display.png)
...
![vector source]({{ site.baseurl }}/images/dsp-intro/vector-source.png)
...
![tau]({{ site.baseurl }}/images/dsp-intro/tau-variable.png)
...
![ex01_4]({{ site.baseurl }}/images/dsp-intro/example-4-flowgraph.png)
![ex01_4_output]({{ site.baseurl }}/images/dsp-intro/example-4-display.png)
...
![ex01_4_output]({{ site.baseurl }}/images/dsp-intro/example-4-updated-display.png).
...
![sampling]({{ site.baseurl }}/images/dsp-intro/sampling.png)

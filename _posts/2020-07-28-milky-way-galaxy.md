...
order: 1
meta_description: "Explore the Milky Way with classroom models and student activities. Learn how a horn radio telescope detects hydrogen in our galaxy."
equipment: "Student worksheets, model diagrams, a spreadsheet, and Stellarium. A telescope is needed only for the final observing activity."
preparation: "Choose activities from the sequence. Review celestial coordinates before observation planning, and prepare the model worksheets in advance."
---


!["DSPIRA Group July 2019, Green Bank, WV"]({{ site.baseurl }}/images/program/2019-dspira-group.jpg)
*DSPIRA Summer Session - July 2019 - Green Bank, West Virginia*

At the heart of the DSPIRA Experience is the development of the Radio Horn Telescope. We can build an inexpensive device that reveals secrets carried by radio waves from space.  A starter telescope cannot reveal everything that Hubble can. Similarly, the DSPIRA Horn Telescope detects only the brightest radio sources.
...
This activity connects to the Earth Motion lesson sequence. It also provides a starting point for sky observations.

**STELLARIUM NOTE:** Several planetarium programs are available. These activities use Stellarium, the program used by DSPIRA teachers.  
**USE DOWNLOAD VERSION** Install Stellarium on the computers you will use to investigate the Milky Way with the horn telescope. It will make the student's observation planning much easier.

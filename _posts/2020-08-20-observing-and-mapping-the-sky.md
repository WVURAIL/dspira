...
![Frequency against radial velocity for neutral hydrogen]({{ site.baseurl }}/images/astronomy/frequency-versus-radial-velocity.png)
...
![The tangent point method]({{ site.baseurl }}/images/astronomy/galactic-rotation.png)

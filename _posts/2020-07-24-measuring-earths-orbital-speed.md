...
Open the [Comparing the Earth Orbit Model to the actual Data Analysis student worksheet](https://drive.google.com/file/d/1Xum-03ijXDn8iplFXZ7dhKvmLEAxcuZu/view?usp=sharing).
...
A working DSPIRA Radio Horn Telescope lets students collect their own galactic-center data. They can analyze its spectrum using the same methods as before (activities 2, 5, and 6)  

![Students Observing the Galactic Center with a Radio Horn]({{ site.baseurl }}/images/program/students-observing-galactic-center.png)

...
equipment: "GNU Radio for the FFT and spectrometer exercises. Connecting the spectrometer to live radio signals additionally requires an SDR receiver."
preparation: "Review Fourier transforms and digital filters first. The eight-point FFT exercise is optional; choose simulation or live receiver input."
---
...
![IQ]({{ site.baseurl }}/images/radio-astronomy-dsp/iq.png)
...
![the two spectrometers]({{ site.baseurl }}/images/radio-astronomy-dsp/spectrometer-comparison.png)
[Credit](#image-credits)
...
![specleak]({{ site.baseurl }}/images/radio-astronomy-dsp/spectral-leakage.png)
[Credit](#image-credits)
...
![windows]({{ site.baseurl }}/images/radio-astronomy-dsp/windows.png)
[Credit](#image-credits)
...
![fftvshan]({{ site.baseurl }}/images/radio-astronomy-dsp/fft-and-hann-window.png)
[Credit](#image-credits)
![rectvshann]({{ site.baseurl }}/images/radio-astronomy-dsp/rectangular-and-hann-windows.png)
...
![pfb]({{ site.baseurl }}/images/radio-astronomy-dsp/polyphase-filter-bank.png)
[Credit](#image-credits)
...
![pfb]({{ site.baseurl }}/images/radio-astronomy-dsp/polyphase-filter-chart.png)
[Credit](#image-credits)
...
![pfbrealized]({{ site.baseurl }}/images/radio-astronomy-dsp/polyphase-filter-implementation.png)
...
![pfb]({{ site.baseurl }}/images/radio-astronomy-dsp/polyphase-flowgraph.png)
...
![airspy bias]({{ site.baseurl }}/images/radio-astronomy-dsp/polyphase-receiver-settings.png)
